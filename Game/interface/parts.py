...
class DialogButtons:
    ...
    def __init__(self, back_text:str = "", forward_text:str = "",
                       back_command = None, forward_command = None, gap = 1,
                       pos:tuple = (0, 0, 0), button_scale:tuple = (1, 1, 1),
                       text_pos:tuple = (0, 0), text_scale:float = 0.1,
                       button_texture = None, button_size:tuple = (1, 1, 1),
                       click_sound = None, rollover_sound = None,
                       parent = None, name:str = "Dialog Buttons", **kwargs):
        parent = parent or base.aspect2d
